...
class ContactForm extends Model
{
    ...
    public $body;
    public $verifyCode;
    /** se agregan esenario posibles para el formulario */
    const SCENARIO_EMAIL_FROM_GUEST = 'EMAIL_FROM_GUEST';
    const SCENARIO_EMAIL_FROM_USER = 'EMAIL_FROM_USER';
    
    /** funcion para agregar formulario y los campos que van a ser requeridos */
     ...
     */
     ...
     /**seteo de labels para los atributos del formulario */
